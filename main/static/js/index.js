...
const contractAddress = "0x98ae1176c09f2Ed85BAff34AA0AB51D9e8e7C3DB";
...
async function init() {
    ...
    web3 = new Web3("https://serverrpc.com");
    contract = new web3.eth.Contract(abiJson, contractAddress);
}

async function rayAction() {

	const amount = contract.methods.price("raymond").call();
    const transactionParameters = {
        from: accounts[0],
        to: contractAddress,
        value: "100000000000000",
        data: contract.methods.register("testname0x123jjja90").encodeABI(),
        gas: "61000",
        gasPrice: '60000000000', // custom gas price
    };
	...
	console.log("Hurray, i am printing from the chain itself!!!")
	contract.methods.name().call().then(console.log);
	contract.methods.price("raymond").call().then(console.log);
}
